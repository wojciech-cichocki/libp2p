...
export const takeSeatRequest = (seatId: number) =>
  action(SeatAction.TAKE_SEAT_REQUEST, seatId);
export const releaseSeatRequest = (seatId: number) =>
  action(SeatAction.RELEASE_SEAT_REQUEST, seatId);

export const currentStateResponse = (seatState: SeatState) =>
  action(SeatAction.CURRENT_STATE_RESPONSE, seatState);
export const takeSeatResponse = (seatRequest: SeatRequest) =>
  action(SeatAction.TAKE_SEAT_HANDLER, seatRequest);
export const releaseSeatResponse = (seatRequest: SeatRequest) =>
