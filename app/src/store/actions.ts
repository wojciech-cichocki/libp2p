...
export const takeSeatRequest = (seatRequest: SeatRequest) => action(SeatAction.TAKE_SEAT_REQUEST, seatRequest)
export const releaseSeatRequest = (seatRequest: SeatRequest) => action(SeatAction.RELEASE_SEAT_REQUEST, seatRequest)